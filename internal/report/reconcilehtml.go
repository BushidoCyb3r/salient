...
<html lang="en"><head><meta charset="utf-8"><title>Defilade reconciliation report</title>
...
<h1>Defilade reconciliation report</h1><p class="meta">snapshot {{.Meta.CreatedAt}} · window {{.Meta.Window}}</p>
...
<p class="meta">The documented role maps to a function Defilade can observe, and observation disagrees. Hosts whose observed role is Unknown are never listed here.</p>
